...
ggsave(file.path(out_dir, "diff_histogram.png"), p_hist, width = 6, height = 4.5, dpi = 300)
ggsave(file.path(out_dir, "boxplot.png"), p_box, width = 4.5, height = 4.5, dpi = 300)
ggsave(file.path(out_dir, "success_bar.png"), p_bar, width = 5.5, height = 4.5, dpi = 300)

panel <- grid.arrange(p_scatter, p_hist, p_box, p_bar, ncol = 2)
ggsave(file.path(out_dir, "summary_panel.png"), panel, width = 10, height = 8, dpi = 300)
