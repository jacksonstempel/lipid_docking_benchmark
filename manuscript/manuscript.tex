...
\begin{enumerate}
    ...
    \item As a fallback, all heteroatoms (O, N, P, S) are considered headgroup atoms.
\end{enumerate}
...
The headgroup definition rule was triggered by phosphorus atoms in 20 ligands, a cationic nitrogen criterion in 1, a carbonyl/oxygen-neighborhood criterion in 73, and by the heteroatom fallback in 7.
...
The benchmark dataset, analysis code, and adversarial mutagenesis pipeline are publicly available to facilitate further method development.

	\section*{Data and Code Availability}
	
	The benchmark dataset, analysis code, and prediction inputs are available at \url{https://github.com/jacksonstempel/lipid_docking_benchmark}.
	The curated benchmark entry list is provided in \texttt{structures/benchmark\_entries.csv}.
...
\begin{tocentry}
\centering
\includegraphics[height=1.72in,keepaspectratio]{toc_graphic.png}
\end{tocentry}
